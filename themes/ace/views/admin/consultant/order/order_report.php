...
$this->renderPartial('../../menu',array(
			'active'=>array('15'=>true, '15.11'=>true),
		));
?>
                ...
                <div class="span12 widget-container-span">
                  <div class="widget-box">
                    <div class="widget-header">
                      <h5 class="smaller">Order Report</h5>
                      ...
                      <div class="widget-main padding-6">
                        <div class="tab-content">
                          <div id="home" class="tab-pane in active">
                           <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('consultant/order/printOrderDaily');?>">
                              <div class="row-fluid">
                          ...
                          <div id="profile" class="tab-pane">
                             <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('consultant/order/printOrderMonthly');?>">
                              <div class="row-fluid">
                          ...
                          <div id="info" class="tab-pane">
                           <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('consultant/order/printOrderYearly');?>">
                            <div class="row-fluid">
                               <label for="form-field-select-3">Year :</label>
                          ...
                          <div id="cc" class="tab-pane">
                             <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('consultant/order/printOrderPeriode');?>">
                               <div class="row-fluid">
                          ...
                          <div id="product" class="tab-pane">
                           <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('consultant/order/printOrderProduct');?>">
                            <div class="row-fluid">
                               <label for="form-field-select-3">Product :</label>

                            <select  id="form-field-select-3" name="product">
