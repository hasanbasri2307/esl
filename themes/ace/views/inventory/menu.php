 ...
 array('label'=>'Dashboard','icon' => 'icon-cloud', 'url'=>array('/inventory'), 'active'=>isset($active['4']) ? true : false),
    array('label'=>'Product','icon' => 'icon-dashboard', 'url'=>array('/accounting/product'), 'active'=>isset($active['1']) ? true : false,
            'items'=> array(
                 ...
                 array('label'=>'Consume Product', 'url'=>array('/inventory/product/consumeProduct'), 'active'=>isset($active['1.14']) ? true : false,),
                 array('label'=>'Master Stock Product', 'url'=>array('/inventory/productStock'), 'active'=>isset($active['1.8']) ? true : false,),
                 array('label'=>'Consume Stock Product', 'url'=>array('/inventory/productStock/consumeProductStock'), 'active'=>isset($active['1.15']) ? true : false,),
