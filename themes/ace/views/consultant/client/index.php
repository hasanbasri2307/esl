...
<<<<<<< HEAD
    <h1>            Clients
=======
    <h1>            Clients hasan basri
>>>>>>> 8bb23399b2dedd2977117e3a8fe169919218f92c
            <small>
                                    ...
                                    <div class="infobox infobox-blue2  ">
                                        <div class="infobox-progress">
                                            <div class="easy-pie-chart percentage" data-percent="90" data-size="90">
                                                <?php if($item->pict == NULL) { echo CHtml::image(Yii::app()->request->baseUrl.'/upload/client/test.jpg',"image",array("class"=>"pict")) ; } else { echo CHtml::image(Yii::app()->request->baseUrl.'/upload/client/'.$item->pict,"image",array("class"=>"pict")) ;} ?>
                                            </div>
                                        </div>
