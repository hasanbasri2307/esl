                      ...
                      <div class="widget-main padding-6">
                        <div class="tab-content">
                          <div id="home" class="tab-pane in active">
                           <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('frontdesk/schedule/printDaily');?>">
                              <div class="row-fluid">
                          ...
                          <div id="profile" class="tab-pane">
                             <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('frontdesk/schedule/printMonthly');?>">
                              <div class="row-fluid">
                          ...
                          <div id="info" class="tab-pane">
                           <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('frontdesk/schedule/printYearly');?>">
                            <div class="row-fluid">
                               <label for="form-field-select-3">Year :</label>
                          ...
                          <div id="cc" class="tab-pane">
                             <form class="form-horizontal" method="POST" action="<?php echo Yii::app()->createUrl('frontdesk/schedule/printPeriode');?>">
                               <div class="row-fluid">
...
<script type="text/javascript">
 ...
 jQuery('#nav-search-input').keypress(function (e) {
  if (e.which == 13) {
    window.location  = "<?php echo Yii::app()->createUrl('/frontdesk/schedule/index/search/')?>/"+jQuery(this).val();
    return false;
  }
});
