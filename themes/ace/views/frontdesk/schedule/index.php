            	...
            	<table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        <thead>
                                <tr>
                                        ...
                                        <th><?php echo $item->room_number;?> (<?php echo $item->room_name;?>)<br><?php $rt= RoomTreatment::model()->with('room')->findAll(array('condition'=>'room.branch_id=:branch_id and room.room_id=:room_id','params'=>array(':branch_id'=>$branch_id,':room_id'=>$item->room_id))); foreach($rt as $vall) { echo $vall->treatment->treatment_name.', ';}}?></th>
