...
class MachineDetailController extends RController
{
	...
	{
		$model=new MesinDetail;
               
		if(isset($_POST['MesinDetail']))
		{
			$model->attributes=$_POST['MesinDetail'];
                        $time = time();
			...
			if($model->save()){
                            ...
                            $this->redirect(array('view','id'=>$model->mesin_detail_id));
                        }
	...
	public function actionIndex($search=NULL)
	{
		...
		$dataProvider=new CActiveDataProvider('MesinDetail', array(
                    'sort'=>$sort,
                    'criteria'=>$criteria,
                    'pagination'=>array(
                        'pageSize'=>20,
	...
	{
		$model=MesinDetail::model()->findByPk($id);
		if($model===null)
