...
class Promo_product_treatmentController extends RController
{
	...
	public function actionView($id)
	{
				...
				$this->render('view',array(
					'model'=>$model,'model_product'=>$model_product, 'model_treatment'=>$model_treatment
				));
	}
	...
	public function actionIndex($search=NULL)
	{
                ...
                $criteria->condition = "type = 'product_treatment'";
                if(isset($search)) 
	...
	{
		$model=Promo::model()->find(array("condition"=>"promo_id=$id AND type='product_treatment'"));
		if($model===null)
