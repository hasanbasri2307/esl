...
/**
 * This is the model class for table "{{level_jabatan}}".
 *
 * The followings are the available columns in table '{{level_jabatan}}':
...
class LevelJabatan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('level_jabatan', 'required'),
			array('level_jabatan', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_level_jabatan, level_jabatan', 'safe', 'on'=>'search'),
		);
	}
