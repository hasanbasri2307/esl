...
class Position extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('position_name, user_id, created, changed', 'required'),
			array('user_id, created, changed, active', 'numerical', 'integerOnly'=>true),
			array('position_name', 'length', 'max'=>40),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('position_id, position_name, user_id, created, changed, active', 'safe', 'on'=>'search'),
		);
	}
